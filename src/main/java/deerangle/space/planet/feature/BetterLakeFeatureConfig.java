...
public class BetterLakeFeatureConfig implements IFeatureConfig {
    ...
    public static final Codec<BetterLakeFeatureConfig> CODEC = RecordCodecBuilder.create(instance -> instance.group(BlockStateProvider.CODEC.fieldOf("fluid_provider").forGetter(inst -> inst.fluidBlock), BlockStateProvider.CODEC.fieldOf("edge_provider").forGetter(inst -> inst.edgeBlock)).apply(instance, BetterLakeFeatureConfig::new));
