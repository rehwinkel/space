...
public class VenusRegistry {
    ...
    public static final RegistryObject<Block> PULCHERITE_TURF = BLOCKS.register("pulcherite_turf", () -> new Block(
            AbstractBlock.Properties.create(Material.ROCK).sound(SoundType.GROUND).hardnessAndResistance(1.0f, 2.0f)));
    public static final RegistryObject<Block> PULCHERITE_COAL = BLOCKS.register("pulcherite_coal", () -> new OreBlock(
    ...
    public static final RegistryObject<Block> PULCHERITE_SULFUR = BLOCKS.register("pulcherite_sulfur",
            () -> new OreBlock(AbstractBlock.Properties.create(Material.ROCK).setRequiresTool()
    ...
    public static final RegistryObject<Block> OVERGROWN_PULCHERITE = BLOCKS.register("overgrown_pulcherite",
            () -> new OvergrownBlock(
                    AbstractBlock.Properties.from(VenusRegistry.PULCHERITE.get()).hardnessAndResistance(2.0F, 6.0F)));
    ...
    public static final RegistryObject<Block> PULCHERITE_BRICKS = BLOCKS.register("pulcherite_bricks",
            () -> new Block(AbstractBlock.Properties.from(VenusRegistry.PULCHERITE.get())));
    ...
    public static final RegistryObject<Block> TURPIUM_ROCK = BLOCKS.register("turpium_rock", () -> new RockBlock(
            AbstractBlock.Properties.from(VenusRegistry.TURPIUM.get()).hardnessAndResistance(0.3F, 3.0F)));
    ...
    public static final RegistryObject<Block> SHRIEKWOOD_LEAVES = BLOCKS.register("shriekwood_leaves",
            () -> new LeavesBlock(
                    AbstractBlock.Properties.create(Material.LEAVES).notSolid().hardnessAndResistance(0.2F)
                            .setBlocksVision((state, reader, pos) -> false).tickRandomly().sound(SoundType.PLANT)));
    public static final RegistryObject<Block> SHRIEKWOOD_PLANKS = BLOCKS.register("shriekwood_planks", () -> new Block(
            AbstractBlock.Properties.create(Material.WOOD).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> SHRIEKWOOD_SAPLING = BLOCKS.register("shriekwood_sapling",
            () -> new ShriekwoodSaplingBlock(
                    AbstractBlock.Properties.create(Material.PLANTS).doesNotBlockMovement().tickRandomly()
    ...
    public static final RegistryObject<Block> SHRIEKWOOD_STAIRS = BLOCKS.register("shriekwood_stairs",
            () -> new StairsBlock(() -> SHRIEKWOOD_PLANKS.get().getDefaultState(),
                    AbstractBlock.Properties.from(SHRIEKWOOD_PLANKS.get())));
    public static final RegistryObject<Block> SHRIEKWOOD_SLAB = BLOCKS
            .register("shriekwood_slab", () -> new SlabBlock(AbstractBlock.Properties.from(SHRIEKWOOD_PLANKS.get())));
    ...
    static {
        ITEMS.register("pulcherite",
                () -> new BlockItem(PULCHERITE.get(), new Item.Properties().group(PlanetManager.TAB)));
        ITEMS.register("pulcherite_turf",
                () -> new BlockItem(PULCHERITE_TURF.get(), new Item.Properties().group(PlanetManager.TAB)));
        ITEMS.register("pulcherite_coal",
                () -> new BlockItem(PULCHERITE_COAL.get(), new Item.Properties().group(PlanetManager.TAB)));
        ITEMS.register("pulcherite_sulfur",
                () -> new BlockItem(PULCHERITE_SULFUR.get(), new Item.Properties().group(PlanetManager.TAB)));
        ITEMS.register("pulcherite_ilmenite",
                () -> new BlockItem(PULCHERITE_ILMENITE.get(), new Item.Properties().group(PlanetManager.TAB)));
        ITEMS.register("overgrown_pulcherite",
                () -> new BlockItem(OVERGROWN_PULCHERITE.get(), new Item.Properties().group(PlanetManager.TAB)));
        ITEMS.register("shriekgrass",
                () -> new BlockItem(SHRIEKGRASS.get(), new Item.Properties().group(PlanetManager.TAB)));
        ITEMS.register("pulcherite_bricks",
                () -> new BlockItem(PULCHERITE_BRICKS.get(), new Item.Properties().group(PlanetManager.TAB)));
        ITEMS.register("polished_pulcherite",
                () -> new BlockItem(POLISHED_PULCHERITE.get(), new Item.Properties().group(PlanetManager.TAB)));
        ...
        ITEMS.register("glowing_turpium",
                () -> new BlockItem(GLOWING_TURPIUM.get(), new Item.Properties().group(PlanetManager.TAB)));
        ITEMS.register("turpium_cobblestone",
                () -> new BlockItem(TURPIUM_COBBLESTONE.get(), new Item.Properties().group(PlanetManager.TAB)));
        ITEMS.register("turpium_rock",
                () -> new BlockItem(TURPIUM_ROCK.get(), new Item.Properties().group(PlanetManager.TAB)));
        ITEMS.register("venus_bacteria",
                () -> new BlockItem(VENUS_BACTERIA.get(), new Item.Properties().group(PlanetManager.TAB)));
        ITEMS.register("shriekwood_log",
                () -> new BlockItem(SHRIEKWOOD_LOG.get(), new Item.Properties().group(PlanetManager.TAB)));
        ITEMS.register("shriekwood_wood",
                () -> new BlockItem(SHRIEKWOOD_WOOD.get(), new Item.Properties().group(PlanetManager.TAB)));
        ITEMS.register("shriekwood_leaves",
                () -> new BlockItem(SHRIEKWOOD_LEAVES.get(), new Item.Properties().group(PlanetManager.TAB)));
        ITEMS.register("shriekwood_planks",
                () -> new BlockItem(SHRIEKWOOD_PLANKS.get(), new Item.Properties().group(PlanetManager.TAB)));
        ITEMS.register("shriekwood_stairs",
                () -> new BlockItem(SHRIEKWOOD_STAIRS.get(), new Item.Properties().group(PlanetManager.TAB)));
        ITEMS.register("shriekwood_slab",
                () -> new BlockItem(SHRIEKWOOD_SLAB.get(), new Item.Properties().group(PlanetManager.TAB)));
        ITEMS.register("slimy_algae", () -> new BlockItem(SLIMY_ALGAE.get(),
                new Item.Properties().group(PlanetManager.TAB)
                        .food(new Food.Builder().fastToEat().hunger(1).saturation(0.05F).build())));
        ITEMS.register("shriekwood_sapling",
                () -> new BlockItem(SHRIEKWOOD_SAPLING.get(), new Item.Properties().group(PlanetManager.TAB)));
        ITEMS.register("crystal_block",
                () -> new BlockItem(CRYSTAL_BLOCK.get(), new Item.Properties().group(PlanetManager.TAB)));
