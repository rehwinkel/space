...
public class VenusRegistry {
    ...
    public static final RegistryObject<Block> GLOWING_TURPIUM = BLOCKS
            .register("glowing_turpium", () -> new GlowingBlock(AbstractBlock.Properties.create(Material.ROCK)));
    ...
    static {
        ...
        ITEMS.register("shriekwood_door",
