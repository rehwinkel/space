...
public abstract class AbstractDimensionGenerator implements IDataProvider {
    ...
    public void act(DirectoryCache cache) {
        ...
        Map<RegistryKey<Dimension>, Dimension> biomeMap = new HashMap<>();
        addDimensions(biomeMap);

        for (Map.Entry<RegistryKey<Dimension>, Dimension> entry : biomeMap.entrySet()) {
    ...
    protected abstract void addDimensions(Map<RegistryKey<Dimension>, Dimension> dimensionMap);
