...
public class ResourceRegistry extends AbstractRegistry {
    ...
    public static final RegistryObject<Block> QUARTZ_SAND = BLOCKS.register("quartz_sand", () -> new FallingBlock(AbstractBlock.Properties.create(Material.SAND).harvestTool(ToolType.SHOVEL).sound(SoundType.SAND).hardnessAndResistance(1.0F, 1.0F)));
