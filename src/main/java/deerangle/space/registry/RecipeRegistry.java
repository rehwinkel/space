...
public class RecipeRegistry extends AbstractRegistry {
    ...
    public static RegistryObject<RefineryRecipeSerializer> REFINERY = RECIPE_SERIALIZERS
            .register("refinery", RefineryRecipeSerializer::new);

    static <T extends IRecipe<?>> IRecipeType<T> register(final String key) {
        return Registry
                .register(Registry.RECIPE_TYPE, new ResourceLocation(SpaceMod.MOD_ID, key), new IRecipeType<T>() {
