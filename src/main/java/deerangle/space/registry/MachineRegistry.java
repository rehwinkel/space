...
public class MachineRegistry extends AbstractRegistry {
    ...
    public static final RegistryObject<Block> GAS_TANK = BLOCKS.register("gas_tank", () -> new GasTankBlock(AbstractBlock.Properties.create(Material.IRON)));

    public static final RegistryObject<Block> DRUM = BLOCKS.register("drum", () -> new DrumBlock(AbstractBlock.Properties.create(Material.IRON)));

    public static final RegistryObject<Block> BATTERY_PACK = BLOCKS.register("battery_pack", () -> new BatteryPackBlock(AbstractBlock.Properties.create(Material.IRON)));

    public static final RegistryObject<Block> REFINERY = BLOCKS.register("refinery", () -> new RefineryBlock(AbstractBlock.Properties.create(Material.IRON)));

    public static final RegistryObject<Block> CABLE = BLOCKS.register("cable", () -> new CableBlock(AbstractBlock.Properties.create(Material.MISCELLANEOUS).sound(SoundType.CLOTH)));

    public static final RegistryObject<Block> PIPE = BLOCKS.register("pipe", () -> new PipeBlock(AbstractBlock.Properties.create(Material.MISCELLANEOUS).sound(SoundType.METAL)));

    public static final RegistryObject<Block> TRANSPORTER = BLOCKS.register("transporter", () -> new TransporterBlock(AbstractBlock.Properties.create(Material.MISCELLANEOUS).sound(SoundType.METAL)));

    public static final RegistryObject<TileEntityType<MachineTileEntity>> MACHINE_TE = TILE_ENTITIES.register("machine", () -> TileEntityType.Builder.create(MachineTileEntity::new, COAL_GENERATOR.get(), BLAST_FURNACE.get(), COMBUSTION_GENERATOR.get(), GAS_TANK.get(), DRUM.get(), BATTERY_PACK.get(), REFINERY.get()).build(null));
    public static final RegistryObject<ContainerType<MachineContainer>> MACHINE_CONTAINER = CONTAINERS.register("machine", () -> IForgeContainerType.create(MachineContainer::new));
    ...
    static {
        ...
        ITEMS.register("combustion_generator", () -> new MachineItem(COMBUSTION_GENERATOR.get(), new Item.Properties().group(TAB)));
